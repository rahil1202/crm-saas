...
import { whatsappInboxRoutes } from "@/modules/whatsapp-inbox/route";
import { whatsappCampaignRoutes } from "@/modules/whatsapp-campaigns/route";
import { whatsappFlowRoutes } from "@/modules/whatsapp-flows/route";
import { whatsappSettingsRoutes } from "@/modules/whatsapp-settings/route";
...
import { googleRoutes } from "@/modules/google/route";
...
api.route("/", whatsappInboxRoutes);
api.route("/", whatsappCampaignRoutes);
api.route("/", whatsappFlowRoutes);
api.route("/", whatsappSettingsRoutes);
