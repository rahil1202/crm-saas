...
whatsappSettingsRoutes.get("/whatsapp/settings", getSettings);
whatsappSettingsRoutes.patch("/whatsapp/settings", requireRole("admin"), validateJson(updateSettingsSchema), updateSettings);
