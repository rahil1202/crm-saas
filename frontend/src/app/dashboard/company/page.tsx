...
import { Building2, CheckCircle2, DoorOpen, Mail, Phone, ShieldCheck, X } from "lucide-react";
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/40 px-4 backdrop-blur-sm">
      <div className="w-full max-w-md rounded-[1.75rem] border border-border/70 bg-white p-5 shadow-[0_30px_90px_-45px_rgba(15,23,42,0.45)]">
        <div className="flex items-start justify-between gap-4">
          ...
          <Button type="button" variant="outline" size="xs" className="hover:border-rose-200 hover:bg-rose-50 hover:text-rose-700" onClick={onCancel}>
            <X className="size-4" />
          </Button>
        </div>
