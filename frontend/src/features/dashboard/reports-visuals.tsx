...
const EmailTrendChart = memo(function EmailTrendChart({
  items,
}: {
...
const GeneralTab = memo(function GeneralTab({ report }: { report: ReportSummaryResponse | null }) {
  return (
...
const FunnelTab = memo(function FunnelTab({ report }: { report: ReportSummaryResponse | null }) {
  return (
...
const OwnersTab = memo(function OwnersTab({ report }: { report: ReportSummaryResponse | null }) {
  return (
...
const ConversionTab = memo(function ConversionTab({ report }: { report: ReportSummaryResponse | null }) {
  return (
...
const LeadsTab = memo(function LeadsTab({ report }: { report: ReportSummaryResponse | null }) {
  return (
...
const DealsTab = memo(function DealsTab({ report }: { report: ReportSummaryResponse | null }) {
  return (
...
const ForecastTab = memo(function ForecastTab({ report }: { report: ReportSummaryResponse | null }) {
  return (
...
const EmailTab = memo(function EmailTab({ report }: { report: ReportSummaryResponse | null }) {
  return (
...
const PartnersTab = memo(function PartnersTab({ report }: { report: ReportSummaryResponse | null }) {
  return (
...
const CampaignsTab = memo(function CampaignsTab({ report }: { report: ReportSummaryResponse | null }) {
  return (
...
export function ReportsVisuals({ report }: { report: ReportSummaryResponse | null }) {
  return (
    <Tabs defaultValue="general" queryKey="tab" className="grid gap-4">
      ...
      <FunnelTab report={report} />
      <OwnersTab report={report} />
      <ConversionTab report={report} />
      <LeadsTab report={report} />
      <DealsTab report={report} />
      <ForecastTab report={report} />
      <EmailTab report={report} />
      <PartnersTab report={report} />
      <CampaignsTab report={report} />
    </Tabs>
  );
}
