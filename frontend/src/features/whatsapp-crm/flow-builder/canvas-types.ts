...
export const NODE_CATALOG: Array<{
  ...
  { type: "send_template", label: "Send Template", category: "action", color: "#8b5cf6", icon: "📋", defaultConfig: { templateName: "", language: "en", components: [] } },
  ...
  { type: "webhook", label: "Webhook", category: "action", color: "#06b6d4", icon: "🌐", defaultConfig: { url: "", method: "POST", headers: {}, bodyTemplate: "" } },
